...
export function loadFromStorage() {
  ...
  //the esence of saving our cart with local storageis to save whatever we have saved in the  cart because if this is not done, once the page isdone everything in the pagefreshes and forgets every action done on the page.
...
//save cart to local storage.local storage can only save strings. the first parameter in localstorage method is the name we want to attribute to the localstorage and the second parameter is the string that will be saved. JSON
